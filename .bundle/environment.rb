...
module Bundler
  ENV_LOADED   = true
  LOCKED_BY    = '0.9.26'
  FINGERPRINT  = "dac25bb6fa97ba3934f1a3241d0fac9d4145d4ad"
  HOME         = '/Users/mancjew/.bundle/ruby/1.8/bundler'
  AUTOREQUIRES = {:default=>[["capistrano-ext", false], ["configatron", false], ["post_commit", false], ["rails", false], ["sqlite3-ruby", false]]}
  SPECS        = [
        ...
        {:load_paths=>["/Users/mancjew/.bundle/ruby/1.8/gems/highline-1.6.1/lib"], :loaded_from=>"/Users/mancjew/.bundle/ruby/1.8/specifications/highline-1.6.1.gemspec", :name=>"highline"},
        {:load_paths=>["/Users/mancjew/.bundle/ruby/1.8/gems/net-ssh-2.0.23/lib"], :loaded_from=>"/Users/mancjew/.bundle/ruby/1.8/specifications/net-ssh-2.0.23.gemspec", :name=>"net-ssh"},
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/net-scp-1.0.2/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/net-scp-1.0.2.gemspec", :name=>"net-scp"},
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/net-sftp-2.0.4/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/net-sftp-2.0.4.gemspec", :name=>"net-sftp"},
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/net-ssh-gateway-1.0.1/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/net-ssh-gateway-1.0.1.gemspec", :name=>"net-ssh-gateway"},

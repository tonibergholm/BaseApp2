...
h2. Roadmap for Rails 3 Version of BaseApp2

I am planning on using the following for the BaseApp2 Rails 3 version.

# CanCan Authentication
# Same theme and styling as the current version
..to be continued...
